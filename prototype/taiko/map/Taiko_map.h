...
{
public:
    Taiko_map(QString map_name , QString duration, QString creator, QString difficulty, QString root_folder, QString map_path, QString song_path, QString song_preview_path , int offset , int note_left);
    ~Taiko_map();
